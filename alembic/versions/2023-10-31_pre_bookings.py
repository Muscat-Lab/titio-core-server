...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["performance_id"],
            ["performances.id"],
            name=op.f("pre_bookings_performance_id_fkey"),
        ),
        sa.ForeignKeyConstraint(
            ["schedule_id"],
            ["schedules.id"],
            name=op.f("pre_bookings_schedule_id_fkey"),
        ),
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name=op.f("pre_bookings_user_id_fkey")
        ),
    ...
    op.create_index(
        op.f("pre_bookings_snowflake_id_idx"),
        "pre_bookings",
        ["snowflake_id"],
        unique=False,
    )
    op.create_table(
        "pre_booking_seat_association",
        ...
        sa.ForeignKeyConstraint(
            ["pre_booking_id"],
            ["pre_bookings.id"],
            name=op.f("pre_booking_seat_association_pre_booking_id_fkey"),
        ),
        sa.ForeignKeyConstraint(
            ["seat_id"],
            ["seats.id"],
            name=op.f("pre_booking_seat_association_seat_id_fkey"),
        ),
        sa.PrimaryKeyConstraint(
            "pre_booking_id", "seat_id", name=op.f("pre_booking_seat_association_pkey")
        ),
    )
